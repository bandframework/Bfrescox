...
A detailed description of the theory behind {{frescox}} can be found in
{cite:t}`Thompson_Nunes_2009`.  For detailed information regarding the
{{bfrescox}} package including the programmatic interface, please refer to the
{{bfrescox}} [User Guide](https://bfrescox.readthedocs.io).
