...
def information():
    """
    All code that would like to use the |frescox| executable built for
    this package should use this information to obtain the absolute path
    to the executable to avoid the situation of simply calling |frescox|
